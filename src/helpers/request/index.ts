...
const makeRequest = (req : RequestPayload) => new Promise((resolve, reject) => {
    ...
    // setup url
    req.url = req.url + (Object.keys(req.query || {}).length ? `?${qs.stringify(req.query)}` : "");
    // has body?
...
// expose methods
exports.post = (pl:Payload) => makeRequest({method : 'POST', url : pl.url, body : pl.body, query : {}});
exports.get = (pl:Payload) => makeRequest({method : 'GET', url : pl.url, body : pl.body, query : {}});
exports.put = (pl:Payload) => makeRequest({method : 'PUT', url : pl.url, body : pl.body, query : {}});
exports.delete = (pl:Payload) => makeRequest({method : 'DELETE', url : pl.url, body : pl.body, query : {}});