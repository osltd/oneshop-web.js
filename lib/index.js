...
class Oneshop extends os_module_1.default {
    constructor(baseUrl) {
        ...
        // setup modules
        this.article = new article_1.default(baseUrl);
        this.cart = new cart_1.default(baseUrl);
        this.consumer = new consumer_1.default(baseUrl);
        this.merchandise = new merchandise_1.default(baseUrl);
        this.order = new order_1.default(baseUrl);
        this.shipping_method = new shipping_method_1.default(baseUrl);
        this.shop = new shop_1.default(baseUrl);
        this.signature = new signature_1.default(baseUrl);
        this.validation = new validation_1.default(baseUrl);
        this.voucher = new voucher_1.default(baseUrl);
    }
