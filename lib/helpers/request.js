...
// expose methods
exports.create = (pl) => makeRequest({ method: 'POST', url: pl.url, body: pl.body, query: pl.query || {} });
exports.get = (pl) => makeRequest({ method: 'GET', url: pl.url, body: pl.body, query: pl.query || {} });
exports.update = (pl) => makeRequest({ method: 'PUT', url: pl.url, body: pl.body, query: pl.query || {} });
exports.remove = (pl) => makeRequest({ method: 'DELETE', url: pl.url, body: pl.body, query: pl.query || {} });
